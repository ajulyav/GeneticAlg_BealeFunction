...
namespace genal
{
    ...
    public class Popul
    {
        ...
        //hk1=0.5*ck1+0.5*ck2, hk2=1.5*ck1-0.5*ck2, hk3=–0.5*сk1+1.5*ck2.
        ...
        public Hrom Mutat_Random()
        {
            ...
            g1.X_gen = h1.Gen_array[randgen].X_gen;

            g1.X_gen = result;

            h1.Gen_array[randgen].X_gen = g1.X_gen;

            hrom.Gen_array = h1.Gen_array;

            hrom.n_GEN = n_GEN;

            hrom.fitness = h1.Func_fitness();
